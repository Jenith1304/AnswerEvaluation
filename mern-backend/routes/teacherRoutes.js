...
const { createTest, deleteTest, getAllTests, getAllQuestions, updateQuestionInTest, addQuestionToTest, removeQuestionFromTest, extractImagesFromPDF ,uploadAnswerSheet} = require('../controllers/TeacherController')
