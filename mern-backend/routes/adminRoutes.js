...
// const { createTeacher, createStudent, createTest, deleteTest, addStandard, addSubjectToStandard, removeSubjectFromStandard, addSubject, deleteSubject, getStandardBasedTeachers, getStandardBasedStudent, assignSubjectToTeacher, removeAssignedSubject, getAllStudents, getAllTeacher, getAllSubjectController, getTeacher, deleteTeacher ,getStudent, deleteStudent, updateStudent, adminDashboard, getAllStandard} = require("../controllers/AdminController");

const { createTeacher, createStudent, createTest, deleteTest, addStandard, addSubjectToStandard, removeSubjectFromStandard, addSubject, deleteSubject, getStandardBasedTeachers, getStandardBasedStudent, assignSubjectToTeacher, removeAssignedSubject, getAllStudents, getAllTeacher, getAllSubjectController, getTeacher, deleteTeacher, getStudent, deleteStudent, updateStudent,adminDashboard ,getStudentAnswersheetController,getAllStandard } = require("../controllers/AdminController");

const adminMiddleware = require("../middlewares/adminMiddleware");
const { getAllTests, updateQuestionInTest, updateMarks } = require("../controllers/TeacherController");
...
router.put("/updateQuestion/:testId/question/:questionId", adminMiddleware, updateQuestionInTest);
...
router.post('/deleteStudent', adminMiddleware, deleteStudent)
router.post('/updateStudent', adminMiddleware, updateStudent)
router.get('/getAnswersheet/:studentId/:testId', adminMiddleware, getStudentAnswersheetController)
router.put("/updateMarks/:testId/:studentId", adminMiddleware, updateMarks);
